...
@if (Auth::user() == null || Auth::user()->role != 'admin')
    ...
    <nav class="navbar navbar-expand-xl navbar-light bg-light">
        <a class="navbar-brand text-dark" href="/"><img src="/img/specialgolflogodark.png"
...
@else
    ...
    <body>
    <nav class="navbar navbar-expand-xl navbar-light bg-light">
        <a class="navbar-brand text-dark" href="/"><img src="/img/specialgolflogodark.png" alt="Special Golf logo"
                                                        aria-label="Logo van Special Golf Haverlij, een kleurrijke zwaan"
                                                        id="logo"></a>
        <button class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#main-navbar"
                aria-controls="main-navbar" aria-expanded="false" aria-label="Toggle navigation">
        ...
        <div class="footer-content bg-light">
            ...
            <ul class='socials text-dark'>
                <li><a class="text-dark"
                       aria-label="Icoontje met link naar het Facebook account van Special Golf Haverlij"
                       href=https://www.facebook.com/DeHaverleij/?locale=nl_NL><i class="fa-brands fa-facebook"></i></a>
                </li>
                <li><a class="text-dark"
                       aria-label="Icoontje met link naar het Instagram account van Special Golf Haverlij"
