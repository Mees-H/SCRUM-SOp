        ...
        <div class="col-sm-8 offset-sm-2">
            ...
            <form method="post" action="{{ route('groups.update', $group->id) }}" enctype="multipart/form-data">
                ...
                <div class="form-group mt-2">
                    ...
                    <input type="text" class="form-control" name="street" id="street" value="{{$group->street}}" required/>
                </div>
                <div class="form-group mt-2">
                    <label for="zipcode"><span class="requiredStar">*</span>Postcode:</label>
                    <input type="text" class="form-control" name="zipcode" id="zipcode" value="{{$group->zipcode}}" required/>
                </div>
                <div class="form-group mt-2">
                    <label for="city"><span class="requiredStar">*</span>Plaats:</label>
                    <input type="text" class="form-control" name="city" id="city" value="{{$group->city}}" required/>
                </div>
                <div class="form-group mt-2">
