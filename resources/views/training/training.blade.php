...
<div class="container">
    ...
    <form class="row justify-content-center d-flex" action="/training" method="post">
        ...
        <button class="btn btn-primary col-md-1" type="submit" name="weekNumber" value="{{$weekFrom - 4}}" aria-label="Knop om vorige 4 weken te bekijken">
        ...
        <button class="btn btn-primary col-md-1" type="submit" name="weekNumber" value="{{$weekFrom + 4}}" aria-label="Knop om volgende 4 weken te bekijken">
            ...
            <div class="row justify-content-center">
                ...
                @foreach($sessions as $session)
                    ...
                    @if($session->weekNumber == $i && $session->year == $year)
                        ...
                        @else
                            <div class="col-auto">{{$session->weekDay}} {{$session->day}} {{$session->month}}</div>
                            <div class="col-auto">{{$session->StartTime}}-{{$session->EndTime}}</div>
