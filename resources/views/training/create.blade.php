        ...
        <div>
            ...
            <form method="post" action="{{ route('trainingsessions.store') }}">
                ...
                <div class="form-group">
                    ...
                    <input type="time" class="form-control @error('time') is-invalid @enderror" name="starttime" id="starttime" value="{{ old('starttime') }}" required/>
                </div><br>

                <div class="form-group">
                    <span class="requiredStar">*</span><label for="endtime">Eindtijd:</label>
                    <input type="time" class="form-control @error('time') is-invalid @enderror" name="endtime" id="endtime" value="{{ old('endtime') }}" required/>
                </div><br>
                ...
                @foreach($groups as $group)
                    <div class="form-check">
                        <input type="radio" class="form-check-input @error('radio') is-invalid @enderror" name="group" id="{{$group->Name}}"
                            value="{{$group->id}}"
